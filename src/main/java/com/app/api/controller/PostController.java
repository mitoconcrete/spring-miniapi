...
public class PostController {
    ...
    public PostResponseDto createPost(@RequestBody PostRequestDto postRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails){
        CreatePostDto createPostDto = new CreatePostDto(postRequestDto.getTitle(), postRequestDto.getContents(), userDetails.getUsername());
    ...
    public PostResponseDto updatePost(@PathVariable Long id, @RequestBody PostRequestDto postRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails){
        UpdatePostDto updatePostDto = new UpdatePostDto(id, postRequestDto.getContents(), userDetails.getUsername());
    ...
    public String deletePost(@PathVariable Long id, @AuthenticationPrincipal UserDetailsImpl userDetails){
        DeletePostDto deletePostDto = new DeletePostDto(id, userDetails.getUsername());
